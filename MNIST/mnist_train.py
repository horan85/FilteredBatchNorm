...
def RunTest(BNType,Epoch,Repeat, BatchSize, FilterValue=4.0):
        ...
        if BNType=="Filtered" or BNType=="FilteredMoments": 
                np.save("res/"+BNType+"_"+str(BatchSize)+"_"+str(FilterValue)+"_train_loss.npy",np.array(train_loss_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_"+str(FilterValue)+"_train_acc.npy",np.array(train_acc_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_"+str(FilterValue)+"_test_loss.npy",np.array(test_loss_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_"+str(FilterValue)+"_test_acc.npy",np.array(test_acc_history))

        else: 
                np.save("res/"+BNType+"_"+str(BatchSize)+"_train_loss.npy",np.array(train_loss_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_train_acc.npy",np.array(train_acc_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_test_loss.npy",np.array(test_loss_history))
                np.save("res/"+BNType+"_"+str(BatchSize)+"_test_acc.npy",np.array(test_acc_history))
...
RunTest("Filtered",Epoch,Repeat,BatchSize,6.0)

RunTest("Filtered",Epoch,Repeat,BatchSize,8.0)
RunTest("Filtered",Epoch,Repeat,BatchSize,7.0)
#print("Test Ref")
